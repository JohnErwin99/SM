<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp_2.aspx.cs" Inherits="SM.SignUp_2" %>
...
<body>
        ...
        <div class="one">
             <main>           
                ...
                <img src="Images/closeup-woman-using-mobile-phone-talking-speaker-while-driving-car.jpg" style="width: 150%; height: 600px; margin-top: -5%; margin-left: -7%; border-radius: 30px 0px 0px 30px;"/>-->

                 <div style="text-align:center; width: 150%; height: 600px; margin-top: -5%; margin-left: -7%;"> 
                 ...
                 <script> 
                    ...
                    <p>Video courtesy of <a href="Images/promo.mp4" target="_blank">Big Buck Bunny</a>.</p>
              ...
              <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show" aria-labelledby="panelsStayOpen-headingOne">
                  <div class="accordion-body">
                      <p>Cloud business phone system powered by a virtual assistant for small and medium size businesses. Evatel Biz includes 2 business lines, 2 internal extensions, smart number for office calls, fax and SMS and a virtual receptionist with personalized call answering and forwarding based on work schedule. Option to keep current number or select a new one. Web portal and mobile app to call, text and manage office communications. Voice messages, SMS and faxes on mobile, Web and by email. Voice assistant to access voicemail and call contacts and colleagues hands-free for safe driving. Choice of fixed and cordless telephone devices with Caller ID, call waiting, 3-way conferencing, call recording, paging, Intercom, etc. Free internet calls while traveling around the world.</p>
                          <ul>
                              <li>
                                1  Phone Line
                              </li>
                          ...
                          <ul>
                             <li>
                                 1  Phone number with 911, Fax and SMS
                  
                             </li>
                          </ul>
                          <ul>
                            <li>1  Speech Attendant
                            </li>
                          </ul>
                          <ul>
                              <li>
                                  1  AmericaUnlimited - Corporate
                              </li>
                          </ul>
                  </div>
                </div>
              ...
              <div class="accordion-item">
                ...
                <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
                  <div class="accordion-body">
                    ...
                    <p class="errMsg"></p>
                            <a href="SignUp_3.aspx"><input type="submit" value="Claim your free trial" id="submit" /></a>
              </div>
            </div>
        </div>
